        ...
        <div class="row">
            <div class="admin-nav p-0">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="admin-notification.php" class="list-group-item text-light admin-link <?= (basename($_SERVER["PHP_SELF"]) == "admin-notification.php") ? "nav-active" : "" ?>"><i class="fas fa-bell"></i>&nbsp;&nbsp;Notification&nbsp;<?= $count->totalCount("notification"); ?></a>
                    ...
                    <a href="admin-videos.php" class="list-group-item text-light admin-link <?= (basename($_SERVER["PHP_SELF"]) == "admin-videos.php") ? "nav-active" : "" ?>"><i class="fas fa-video"></i>&nbsp;&nbsp;Upload Videos</a>
                    <a href="admin-carousel.php" class="list-group-item text-light admin-link <?= (basename($_SERVER["PHP_SELF"]) == "admin-carousel.php") ? "nav-active" : "" ?>"><i class="fas fa-copyright"></i>&nbsp;&nbsp;Carousel Companies</a>
                    <a href="admin-reviews.php" class="list-group-item text-light admin-link <?= (basename($_SERVER["PHP_SELF"]) == "admin-reviews.php") ? "nav-active" : "" ?>"><i class="fas fa-comments-dollar"></i>&nbsp;&nbsp;Reviews</a>
                    <a href="admin-resume.php" class="list-group-item text-light admin-link <?= (basename($_SERVER["PHP_SELF"]) == "admin-resume.php") ? "nav-active" : "" ?>"><i class="fas fa-file"></i>&nbsp;&nbsp;Resume</a>
