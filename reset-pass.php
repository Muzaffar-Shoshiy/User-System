            ...
            <div class="col-lg-10 my-auto">
                <div class="card-group myShadow">
                    ...
                    <div class="card rounded-right p-4" style="flex-grow:2;">
                        <h1 class="text-center font-weight-bold text-warning">Enter New Password!</h1>
                        <hr class="my-3">
                        <form action="" method="post" class="px-3">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Reset Password" name="submit" class="btn btn-warning btn-lg btn-block myBtn rounded-0 text-white font-weight-bold">
                            </div>
                        </form>
                    </div>
                </div>
