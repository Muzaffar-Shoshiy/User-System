<?php
    ...
    if(isset($_POST["action"]) && $_POST["action"] == "verify_email"){
        try {
            ...
            $mail->Body = "<h3>Click the below link to verify your E-Mail.<br><a href='http://localhost/portfolio/verify-email.php?email=".$cemail."'>http://localhost/portfolio/verify-email.php?email=".$cemail."</a><br>Regards<br>Muzaffar!</h3>";
        ...
        if($notification){
            foreach($notification as $row){
                $output .= '<div class="alert alert-danger" role="alert">
                                ...
                                <p class="mb-0 lead notificationMsg">'.$row['message'].'</p>
                                <hr class="my-2">
                                <div class="notificationAlert mt-1">
